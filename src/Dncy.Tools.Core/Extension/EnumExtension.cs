...
namespace Dncy.Tools
{
    public static class EnumExtension
    {
        ...
        /// <returns></returns>
        public static Dictionary<int, string> GetValueNameDictionary(this Type enumType)
        {
            if (!enumType.IsEnum)
            {
        ...
        /// <param name="enumType"></param>
        /// <returns></returns>
        public static Dictionary<string, int> GetNameValueDictionary(this Type enumType)
        {
            if (!enumType.IsEnum)
            {
                throw new Exception("给定的类型不是枚举类型");
